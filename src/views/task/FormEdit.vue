...
export default {
    ...
    mounted () { 
            ...
            axios
            .get(BASE_URL + 'tarefa/'+this.$route.params.id,{ headers: {"Authorization" : `Bearer ${JWTToken.access_token}`} })
            .then(response => {  
                //this.user = response.data
                this.id = response.data.id
                this.name = response.data.name
                this.date_conclusion = response.data.date_conclusion
